pipeline {
    ...
    environment {
        ...
        TOMCAT_URL = 'http://98.87.16.59:9090/manager/text'
        TOMCAT_USER = 'admin'
        TOMCAT_PASS = 'admin'
    ...
    stages {
        stage('Clone Repository') {
            steps {
               git credentialsId: 'Github token', url: 'https://github.com/naveenpadeti/fullstackapp.git', branch: 'main'
            }
        }
    ...
    post {
        success {
            echo "✅ Backend deployed: http://98.87.16.59:9090/springapp1"
            echo "✅ Frontend deployed: http://98.87.16.59:9090/frontapp1"
        }
        failure {
